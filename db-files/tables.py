...
# read tables
user_df = pd.read_pickle("df_user_CLEANED")
movie_df = pd.read_pickle("df_movie_CLEANED")
rating_df = pd.read_pickle("df_rating_CLEANED")
...
user_df.to_pickle(currdir + '/df_user_UPDATED')
movie_df.to_pickle(currdir + '/df_movie_UPDATED')
...
rating_df.to_pickle(currdir + '/df_rating_UPDATED')
