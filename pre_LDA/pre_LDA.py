...
def input_LDA(vocab, desc, regex=None):
    """
    ...
    for d in desc:
        ...
        with open("input_LDA.txt", 'a', encoding='utf-8') as f:
            ...
            f.write(map_counts)
            f.write("\n")
    print("Prep time of input_LDA.txt: {:.2f} seconds".format(time.time() - start))
    print("-*-*-*-")
...
for i in range(2):
    my_text += train
my_text = my_text[0:200] #[7 minutes / :15,000 docs]
_example1 = ["This is a foo_bar this sentence sentence. But also this sentence #$^&*@hello_world.123", "car's solution, red's solution car , is his number of 100s 70s, 50 "]
